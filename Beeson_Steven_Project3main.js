...
console.log(json)
var advPrompt = prompt("Shall we throw " + char[0] + ", " + char[1] + ", and " + char[2] + " into and adventure?")
if(advPrompt === "yes"){
	alert("Let's do it!!")
...
prompt = function busOpts(parseInt){

var busOpts = " - What bus would you like " + char[0] + ", " + char[1] + ", and " + char[2] + " to ride?\n=============================\n" + "Bus 1 (Lansing Mall)?\n" + "Bus 2 (Meridian Mall)?\n" + "Bus 3 (WalMart)?\n"
